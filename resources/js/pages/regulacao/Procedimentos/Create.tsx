...
export default function Create({ grupos }: CreateProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('regulacao.procedimentos.store'));
  };
    ...
    <AppLayout>
      <div className="space-y-6 p-4 max-w-xl mx-auto">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-blue-800">Novo Procedimento</h1>
        </div>
        <Card>
          <CardHeader>
