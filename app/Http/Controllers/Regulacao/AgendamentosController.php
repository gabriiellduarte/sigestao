...
class AgendamentosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ], RegAtendimento::getValidationMessages());
    ...
    public function espera($grupo = null)
    {
        $query = RegAtendimento::with([
            'pessoa',
            'procedimento',
            'grupoProcedimento',
            'tipoAtendimento',
        ...
        if ($grupo && $grupo !== 'todos') {
            $query->whereHas('grupoProcedimento', function($q) use ($grupo) {
                $q->where('reg_gpro_nome', $grupo);
            });
        }
